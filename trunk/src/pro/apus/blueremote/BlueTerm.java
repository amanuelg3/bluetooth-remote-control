...
public class BlueTerm extends Activity {
    ...
    private RemoteView mRemoteView = null;
...
//    };
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mRemoteView = (RemoteView) findViewById(R.id.remoteView);
	...
	private void selectEmulatorView()
	{
        mEmulatorView.setFocusable(true);
        mEmulatorView.setFocusableInTouchMode(true);
        mEmulatorView.requestFocus();
        mEmulatorView.register(mKeyListener);		
        mEmulatorView.setVisibility(View.VISIBLE);
        //mRemoteView.setVisibility(View.GONE);
	}

	private void selectRemoteView()
	{
		mRemoteView.setFocusable(true);
		mRemoteView.setFocusableInTouchMode(true);
		mRemoteView.requestFocus();	
		//mRemoteView.setVisibility(View.VISIBLE);
		//mEmulatorView.setVisibility(View.GONE);
		
		mBluetoothTask = new BluetoothTask();
		mBluetoothTask.execute();
	}
	...
	private class BluetoothTask extends AsyncTask<Void, String, Void> {
		...
		protected void onProgressUpdate(String... progress) {
			...
			mRemoteView.updateStatus(progress[0]);
		}
...
//            if (mRemoteView != null && mRemoteView.isShown()) {
//            	selectEmulatorView();
//            	return true;
//            }
//            else {
...
//    	else 
    ...
    private void doCustomRemoteView() {
    	selectRemoteView();	
	}
